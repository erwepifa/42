...
const send = require('gmail-send')({user: 'r00tmatcha@gmail.com',pass: 'Lastmen00'});
...
//         db.execute("SELECT FROM users WHERE password = ?", [oldpassword]).then((result) => {
